...
export default function FotosPerfilECapaConfig() {
  ...
  const handleClick = async (e) => {
    ...
    try {
      ...
      const atualizarUser = await api.put(
        `/user/atualizar/${id}`,
        {
    ...
    <>
      <div className="fotosPerfilECapaConfig">
        <div className="divEditarCapa">
          ...
          <label
            htmlFor="file-upload-capa"
            className="labelEditarCapa"
            style={{ cursor: "pointer" }}
          >
            <img
              src={iconeImagemPost1}
              alt="Ícone de imagem"
              className="iconeEditarImagemCapa"
            />
            <input
              id="file-upload-capa"
              type="file"
              className="inputEnviarImagemCapa"
              accept="image/*"
        ...
        <div className="divEditarPfp">
          ...
          >
            <img
              src={iconeImagemPost1}
              alt="Ícone de imagem"
              className="iconeEditarImagem"
            />
            <input
              id="file-upload-perfil"
              type="file"
              className="inputEnviarImagemPerfil"
              accept="image/*"
      ...
      <div className="containerCursoEBio">
        <div className="editarInformacoesPerfil">
          ...
          <p onClick='' style={{color:'#FF2626', cursor:'pointer', fontSize: '22px'}}>Sair</p>
        </div>
